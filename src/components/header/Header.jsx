...
function Header() {
  ...
  return (
    <header className=" min-h-screen max-h-content gap-5 flex flex-col-reverse items-center justify-center md:flex-row mx-auto md:justify-between md:gap-12 md:items-center w-max-[1200px] w-[90%]">
      <Top />
      ...
      <div>
        <img
          className="w-32 md:w-72 md:block"
