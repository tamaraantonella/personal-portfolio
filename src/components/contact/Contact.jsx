...
export default function Contact() {
  ...
  return (
    ...
    >
      <h5 className={`text-color_light md:text-lg text-center `}>{t("contact.intro")}</h5>
      ...
      <div className="flex flex-col md:flex-row gap-8  mx-auto justify-center mt-8">
        <div className="flex gap-5">
          <div className="flex items-center gap-3">
            <a
              className="text-color_light lg:text-5xl hover:text-color_white transition-all ease-in-out duration-300 text-2xl"
